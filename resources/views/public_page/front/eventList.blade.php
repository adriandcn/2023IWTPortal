...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('public_components/css/bootstrap.min.css')}}" type='text/css'>
        <link rel="stylesheet" href="{{ asset('public_components/css/font-awesome.min.css')}}" type='text/css'>
        ...
        <link rel="stylesheet" href="{{ asset('public_components/css/animate.min.css')}}" type='text/css'>
        ...
        <!-- Main Style -->
        <link id="main-style" rel="stylesheet" href="{{ asset('public_components/css/style.css')}}" type='text/css'>

        <!-- Updated Styles -->
        <link rel="stylesheet" href="{{ asset('public_components/css/updates.css')}}" type='text/css'>

        <!-- Custom Styles -->
        <link rel="stylesheet" href="{{ asset('public_components/css/custom.css')}}" type='text/css'>

        <!-- Responsive Styles -->
        <link rel="stylesheet" href="{{ asset('public_components/css/responsive.css')}}" type='text/css'>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div id="main" class="col-sm-8 col-md-9">
                        ...
                        @endif
                        <div class="products row add-clearfix catagorias">

                                <div class="form-group-1 text-center">
                                    <span style="color: black !important;font-size: 1.5em !important;margin-right: 5px !important;"> Eventos </span>
                                    <select name="id_canton_evento" id="id_canton_evento" class="input-text chng" style="height: 40px;width: 50%;" onchange="buscarCanton();">
                                        <option value="0"> Seleccionar </option>
                                        @foreach($cantonesPorEventos as $tipos)
                                        ...
                                        <div class="iso-container iso-col-2 style-masonry has-column-width">
                                            ...
                                            <div class="iso-item">
                                                <article class="post post-masonry">
                                                    <div class="post-date" style="width: 35% !important;font-weight: bold !important;font-size: 1em !important;">
                                                        ...
                                                        <table style="width: 100% !important;">
                                                            <tr>
                                                                <td style="padding: 0 !important;width:30%">
                                                                    ...
                                                                    @else
                                                                        <img class="thumbnail" src="{{ asset('images/icon/'.$event->foto[0]->filename)}}" alt="" style="width: 100% !important;height: auto !important;padding: 0 !important;margin-top: 2px !Important;">
                                                                    @endif
                                                                </td>
                            ...
                            <div class="text-center" style="margin-top: 8px !important;display: block;" id="verMas">
                                <a  class="btn style4 hover-blue moreImgEvents" >{{ trans('publico/labels.label31')}}</a>
                            </div>
                            <input type="hidden" value="7" id="valorPagina"/>
...
<script>
    ...
    function buscarCanton(){
        ...
        var valor = $("#id_canton_evento").val();
        window.location = "/eventList/" + valor;
    }

    $(".moreImgEvents").click(function () {
        //$('.woocommerce').LoadingOverlay('show');
        var valor=$("#valorPagina").val();
        valor = parseInt(valor);
        var contador = valor + 7;
        console.log(contador);
        GetDataAjaxSearchEvents("{!!asset('/getSearchTotalEvents')!!}",contador);
        $("#ocultar").hide();
        reloadStylesheets();
        //window.location = "/eventList/step/" + contador;
        //GetDataAjaxSearchEvents("{!!asset('/getSearchTotalEvents')!!}/"+contador);
        /*$("#ocultar").css("display", "none");*/
        //$("#ocultar").hide();
        //$("#valorPagina").val(contador);
    });
