                                ...
                                <tbody><tr>
                                        <td class="column" style="padding: 0;vertical-align: top;text-align: left;">
                                            ...
                                            <div class="image" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: Cabin,Avenir,sans-serif;color: #fff;" align="center">
                                                <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 900px;" src="{!! url(env('AWS_PUBLIC_URL').'images/img/cotopaxi.jpg')!!}" alt="iguanatrip.com" width="600" height="293" />
                                            </div>
                                                ...
                                                <tbody><tr>
                                                        <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word;text-align: left;">
                                                            ...
                                                            <p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 16px;font-size: 14px;line-height: 22px;font-family: Cabin,Avenir,sans-serif;color: #fff;">
                                                                Informaci&#243;n del Operador del Servicio:</p>
                                                            <ul style="font-style: normal;font-weight: 400;padding-left: 0;Margin-bottom: 32px;Margin-top: 32px;font-size: 14px;line-height: 22px;font-family: Cabin,Avenir,sans-serif;color: #fff;Margin-left: 48px;">
                                                                ...
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 0;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Nombre del Operador:</strong> {!!$nombreoperador!!} </li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Empresa del Operador:</strong> {!!$empresaoperador!!}</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Direeci&#243;n del Operador:</strong> {!!$direccionoperador!!}</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Tel&#233;fono del Operador:</strong> {!!$telefonooperador!!}</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Correo del Operador:</strong> {!!$correooperador!!}</li>
                                                            </ul>

                                                             <p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 16px;font-size: 14px;line-height: 22px;font-family: Cabin,Avenir,sans-serif;color: #fff;">
                                                                Informaci&#243;n de la Reservaci&#243;n:</p>
                                                            <ul style="font-style: normal;font-weight: 400;padding-left: 0;Margin-bottom: 32px;Margin-top: 32px;font-size: 14px;line-height: 22px;font-family: Cabin,Avenir,sans-serif;color: #fff;Margin-left: 48px;">

                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 0;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Nombre del Servicio:</strong> {!!$nombrecalendario!!}</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Nombre del Cliente:</strong> {!!$nombrepara!!}</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Correo del Cliente:</strong> {!!$correo!!}</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Reserva Desde:</strong> {!!$desde!!}</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Reserva Hasta:</strong> {!!$hasta!!}</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Adultos:</strong> {!!$adultos!!}</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Ni&#241;os:</strong> {!!$ninos!!}</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Estado de la Reservaci&#243;n:</strong> {!!$estadoreserva!!}</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Fecha de Pago de la Reservaci&#243;n:</strong> {!!$fechapago!!}</li>
                                                                 <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    <strong>Monto Total Reservaci&#243;n:</strong> {!!$montopago!!}</li>
                                                            </ul>

                                                            <!-- <p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 16px;font-size: 14px;line-height: 22px;font-family: Cabin,Avenir,sans-serif;color: #fff;">
                                                                Codigo de la Reservaci&#243;n:</p> -->
                                                            <ul style="font-style: normal;font-weight: 400;padding-left: 0;Margin-bottom: 32px;Margin-top: 32px;font-size: 14px;line-height: 22px;font-family: Cabin,Avenir,sans-serif;color: #fff;Margin-left: 48px;">
                                                                <div id="qrcode"></div>
                                                                <?php
                                                               ...
                                                               //echo DNS2D::getBarcodeHTML("4445645656", "QRCODE",10,10);
                                                                ?>
                                                                 <?php
                                                                /*echo "<div style='width: 80%;border: 1px solid red;'>";
                                                                $codigo = $uuid;
                                                                echo $codigo;echo "<br>";
                                                                $qr = DNS2D::getBarcodeHTML($codigo, "QRCODE",500,1);
                                                                echo '<img src="'.$qr.'" width="100%" />';
                                                                echo "</div>";*/
                                                                ?>
