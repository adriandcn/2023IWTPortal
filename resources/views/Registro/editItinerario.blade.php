                    ...
                    <tr>
                        <td>
                            <div id="promocion" style="margin-left: 145px">
                                ...
                                <a onclick="RenderPartialGenericFotografia('reusable.uploadImagePopUp', 3, {!!$itiner->id_usuario_servicio!!}, {!!$itiner->id!!})" href="#"><img src="{{ url(env('AWS_PUBLIC_URL').'images/img/fotograf.png')}}" style="width:111px"></a>
                            </div>
                        </td>
                    </tr>
                </table>
