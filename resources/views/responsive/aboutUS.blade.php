 ...
 <section id="content">
            <div class="container">
                ...
                <div id="main">
                    ...
                    <?php $str2=utf8_encode("Debido a la gran belleza natural y multiculturalidad del Ecuador, este ostenta un incre�ble atractivo tur�stico. iWaNaTrip busca desarrollar este potencial dando a conocer los encantos naturales y la riqueza socio-cultural del Ecuador, interna e internacionalmente. ") ?>
                    <?php $str3=utf8_encode("Nuestro equipo de trabajo y aliados estrat�gicos trabajan para posicionar al Ecuador como un destino encantador, amigable y accesible. Juntos haremos haremos de esta comunidad turistica la m�s completa y grande del pa�s.") ?>
           ...
           <div class="section-info">
                ...
                <div class="tab-container vertical-tab">
                  <div id="tab3-3" class="tab-content in active">
                        <div class="tab-pane">
                            <img src="https://iwannatrip.s3.us-east-1.amazonaws.com/images/img/logo_iwana2.jpg" alt="" class="pull-left">
                            <p>{!!$str2!!}</p>
                            <p>{!!$str3!!}</p>
