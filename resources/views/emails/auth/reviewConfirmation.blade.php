...
<!--<![endif]-->
    <center style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #f5f7fa;" class="wrapper">
          ...
          <table style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;" class="centered">
            ...
            <h2 style="font-style: normal;font-weight: 700;Margin-bottom: 0;Margin-top: 0;font-size: 24px;line-height: 32px;font-family: &quot;Open Sans&quot;,sans-serif;color: #f05a22;text-align: center;">Hemos recibido tu comentario</h2><p style="font-style: normal;font-weight: 400;Margin-bottom: 24px;Margin-top: 16px;font-size: 15px;line-height: 24px;font-family: &quot;Open Sans&quot;,sans-serif;color: #60666d;text-align: center;">Gracias por ayudar a que nuestra comunidad crezca. Juntos daremos a conocer el potencial turístico del Ecuador a nivel mundial. <br><strong>{!! link_to('review/confirm/' . $confirmation_rev_code, $link) !!}</strong></p>
            ...
            <div align="center" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: &quot;Open Sans&quot;,sans-serif;color: #60666d;" class="image">
              <a href="https://iwannatrip.com/ServiciosOperadores" style="transition: opacity 0.2s ease-in;color: #5c91ad;" target="_blank"><img width="600" height="400" alt="iWaNaTrip" src='https://iwannatrip.com/img/review_confirmation.jpg' style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 900px;"></a>
            </div>
