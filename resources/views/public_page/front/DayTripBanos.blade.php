...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    ...
    ?>
		<meta name="description" content='Day Trips Baños |iWaNaTrip.com'>
    <meta name="keywords" content="Day Trips Baños">
	...
	<meta property="og:title" content="Day Trips Baños" />
    <meta property="og:description" content="Day Trips Baños" />
...
<script>
    ...
    <body class="woocommerce">
		...
		<div class="page-title-container">
           ...
           <ul class="breadcrumbs">
                ...
                <li class="active">Day Trips Baños</li>
            </ul>
        </div>
		@else
            ...
            <div class="page-title">
                <div class="container">
                    <h1 class="whitex">Day Trips Baños</h1>
                </div>
            </div>
            <ul class="breadcrumbs">
                <li>
                    ...
                    <div id="main" class="col-sm-8 col-md-9">
                        ...
                        <div class="image-banner box">
                            <div class="image-container">
                                ...
                                <img src="{{ url(env('AWS_PUBLIC_URL').'images/img/serr/daytrips.jpg')}}" alt="banos_iWaNaTrip">

                            </div>
                            <div class="caption-wrapper position-left">
                                <div class="captions">
                                       @if(session('locale') == 'es' )
                                          <h2>Day Trips Baños</h2>
                                            @else
                                           <h2>Day Trips Baños</h2>
                                            @endif
                      ...
                      <!--  <form method="get" class="woocommerce-ordering box">
                         ...
                         <div class="post-filters">
                            ...
                            <a href="#" class="btn btn-sm style4 hover-blue" data-filter="first">30$</a>
                            <a href="#" class="btn btn-sm style4 hover-blue" data-filter="second">60$</a>
   ...
   <div class="TopPlace">
             ...
             <div class="iso-item filter-all filter-website first">
                                <article class="post">

										@if(session('locale') == 'es' )
                                        <a href="{!!asset('/tour/Rafting-Baños---Ecuador-(Level-III-and-IV)-Upper-Pastaza-river/2152/29')!!}/"   class="product-image">

									@else
										<a href="{!!asset('/en/tour/Rafting-Baños---Ecuador-(Level-III-and-IV)-Upper-Pastaza-river/2152/29')!!}/"   class="product-image">
									@endif


                                    <img src="https://bookiw.iwannatrip.com/app/web/uploads/29IMGP1326.jpg" alt="baños">
                                        <span class="image-extras"></span>
                                    </a>
                                    <div class="portfolio-content">

                                        <h5 class="portfolio-title"><a href="{!!asset('/tour/Rafting Baños - Ecuador (río Pastaza) Nivel III and IV')!!}/" >{{(session('locale') == 'es' )?"Rafting Baños - Ecuador (río Pastaza) Nivel III and IV":"Rafting Baños - Ecuador (Level III and IV) Upper Pastaza river"}}</a></h3>
    ...
    margin-right: 8px;"><span class="currency-symbol">{{ trans('publico/labels.label59')}} $</span>30</span>
             ...
             <div class="iso-item filter-all filter-website first">
                                <article class="post">
										...
										@if(session('locale') == 'es' )
                                        <a href="{!!asset('/tour/Canyoning-Baños---Ecuador-(White-River)-Level-III-/2152/30')!!}/"   class="product-image">

									@else
										<a href="{!!asset('/en/tour/Canyoning-Baños---(Rio-Blanco)-Nivel-III/2152/30')!!}/"   class="product-image">
									@endif


                                    <img src="https://bookiw.iwannatrip.com/app/web/uploads/30DSCF0081 copy.jpg" alt="bañostour">
                                        <span class="image-extras"></span>
                                    </a>
                                    <div class="portfolio-content">

                                        <h5 class="portfolio-title"><a href="{!!asset('/tour/Tour-Los-Túneles----(isla-Isabela---Galápagos)--Snorkelling/2107/37')!!}/" >{{(session('locale') == 'es' )?"Canyoning Baños (Rio Blanco) Nivel III":"Canyoning Baños - Ecuador (White River) Level III"}}</a></h3>
    ...
    margin-right: 8px;"><span class="currency-symbol">{{ trans('publico/labels.label59')}} $</span>30</span>
             ...
             <div class="iso-item filter-all filter-website second">
                                <article class="post">

										@if(session('locale') == 'es' )
                                        <a href="{!!asset('/tour/Canyoning-Baños---Ecuador-(Cashaurco)-Level-IV-/2152/31')!!}/"   class="product-image">

									@else
										<a href="{!!asset('/en/tour/Canyoning-Baños---Ecuador-(Cashaurco)-Level-IV-/2152/31')!!}/"   class="product-image">
									@endif


                                    <img src="https://bookiw.iwannatrip.com/app/web/uploads/31[000045].jpg" alt="canoying">
                                        <span class="image-extras"></span>
                                    </a>
                                    <div class="portfolio-content">

                                        <h5 class="portfolio-title"><a href="{!!asset('/tour/Tour-Tintoreras----(isla-Isabela---Galápagos)--Snorkelling/2107/38')!!}/" >{{(session('locale') == 'es' )?"Canyoning Baños - Ecuador (Cashaurco)Nivel IV":"Canyoning Baños - Ecuador (Cashaurco) Level IV"}}</a></h3>
    ...
    font-size: 1.3333em;
    font-weight: 600;
    margin-right: 8px;"><span class="currency-symbol">{{ trans('publico/labels.label59')}} $</span>60</span>
