...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        <!-- Page Title -->
        <title>iWanaTrip | Vive la experiencia Ecuador {!!$catalogo->nombre_servicio!!}</title>
        ...
        <meta name="description" content="iWanaTrip.com {!!$catalogo->nombre_servicio!!} {{ \Carbon\Carbon::now()->toDateString() }} ">
...
<ul class="breadcrumbs">
		...
		$foo = @file_get_contents(("http://ipinfo.io/" . $ipUser));
		if( FALSE === $foo ){
                    ...
                    <div id="main" class="col-sm-8 col-md-9">
                        ...
                        <div class="image-banner box">
                            <div class="image-container">
                                ...
                                <img src="{{ url(env('AWS_PUBLIC_URL').'images/img/serr/night.jpg')}}" alt="activities_iWaNaTrip">
                                @endif
                            </div>
