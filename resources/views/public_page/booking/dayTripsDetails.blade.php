...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        <!-- Page Title -->
        <title>{{ $nombreCanton }} iWaNaTrip - |Galapagos Transfers |DayTrips Ecuador |Discover Ecuador</title>
    ...
    ?>
	<meta name="description" content="{{ $nombreCanton }} iWaNaTrip| Buy your ferry tickets for Galapagos Islands online | Buy your day Trips online| Discover Ecuador">
    <meta name="keywords" content="{{ $nombreCanton }} iWaNaTrip| Buy your ferry tickets for Galapagos Islands online | Buy your day Trips online| Discover Ecuador">
	...
	<meta property="og:title" content="{{ $nombreCanton }}" />
    <meta property="og:description" content="{{ $nombreCanton }} Ecuador" />
            ...
            @if(session('device')!='mobile')
                <div class="page-title-container">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li class="active">Day Trips {{ $nombreCanton }}</li>
                    </ul>
                </div>
            @else
		 		<div class="page-title-container  " style="background-size: cover; background-image: url(../../img/serr/ferry.jpg)"data-stellar-background-ratio="0.5" id="bgTop">
                    <div class="page-title">
                        <div class="container">
                            <h1 class="whitex">Day Trips {{ $nombreCanton }}</h1>
                        </div>
                    </div>
                    <ul class="breadcrumbs">
                        <li>
                    ...
                    <div class="row">
                        ...
                        <div id="main" class="col-sm-8 col-md-9">
                            ...
                            <div class="post-filters">
                                ...
                                <a href="#" class="btn btn-sm style4 hover-blue" data-filter="{!! $searchCanton !!}">{{ $nombreCanton }}</a>
                            </div>
                            ...
                            @if(count($agrupamientos)>0)
                                ...
                                <div class="TopPlace">
                                    @foreach($agrupamientos as $agrupamiento)
                                        ...
                                        <div class="iso-item filter-all filter-website {!! $searchCanton !!}">
                                            <article class="post">

                                                @if(session('locale') == 'en' )
                                                    <a href="{!!asset('/tour')!!}/{!!$agrupamiento[0]->nombre_eng!!}/{!!$agrupamiento[0]->id_usuario_servicio!!}/{!!$agrupamiento[0]->id!!}" class="product-image">
                                                        <img src="https://bookiw.iwannatrip.com/app/web/uploadsMobile/{!!$agrupamiento->foto[0]->filename!!}" alt="{!! $searchCanton !!}">

                                                        <span class="image-extras"></span>
                                                    </a>
                                                @else
                                                    <a href="{!!asset('/tour')!!}/{!!$agrupamiento[0]->nombre!!}/{!!$agrupamiento[0]->id_usuario_servicio!!}/{!!$agrupamiento[0]->id!!}" class="product-image">
                                                        <img src="https://bookiw.iwannatrip.com/app/web/uploadsMobile/{!!$agrupamiento->foto[0]->filename!!}" alt="{!! $searchCanton !!}">
                                                        <span class="image-extras"></span>
                                                    </a>
                                                @endif
                                                ...
                                                <div class="portfolio-content">
                                                    @if(session('locale') == 'en' )
                                                        <h5 class="portfolio-title"><a href="{!!asset('/tour')!!}/{!!$agrupamiento[0]->nombre_eng!!}/{!!$agrupamiento[0]->id_usuario_servicio!!}/{!!$agrupamiento[0]->id!!}">{{$agrupamiento[0]->nombre_eng}}</a></h3>
                                                    @else
                                                        <h5 class="portfolio-title"><a href="{!!asset('/tour')!!}/{!!$agrupamiento[0]->nombre!!}/{!!$agrupamiento[0]->id_usuario_servicio!!}/{!!$agrupamiento[0]->id!!}">{{$agrupamiento[0]->nombre}}</a></h3>
                                                    @endif

                                                    @if($agrupamiento[0]->precioDesde == 0)
                                                        <span class="product-price " style=" color: #eb3b50;float: left;font-size: 1.3333em;font-weight: 600;margin-right: 8px;"> {{(session('locale') == 'es' )?"Gratis":"Free"}} </span>
                                                    @else
                                                        <span class="product-price " style=" color: #eb3b50;float: left;font-size: 1.3333em;font-weight: 600;margin-right: 8px;"><span class="currency-symbol">{{ trans('publico/labels.label59')}} $</span>{{$agrupamiento[0]->precioDesde}}</span>
                                                    @endif
                                                    <br/>
                                                    <br/>
                                                </div>
        ...
        <style>
            ...
            */
            .jssora12l, .jssora12r {
                ...
                height: 46px;
                cursor: pointer;
                background:url("{!!asset("https://iwannatrip.s3.us-east-1.amazonaws.com/images/img/2.png")!!}") no-repeat;
                overflow: hidden;
            }
