    ...
    <div id="part-1-form">
        ...
        <div id="secondary-data">
            <div id="promocion" style="margin-left: 145px">
                ...
                <a onclick="RenderPartialGenericFotografia('reusable.uploadImagePopUp', {!!$typeGeo!!},0, {!!$id!!})" href="#"><img src="{{ url(env('AWS_PUBLIC_URL').'images/img/fotograf.png')}}" style="width:111px"></a>
            </div>
        </div>
    </div>
</div>
