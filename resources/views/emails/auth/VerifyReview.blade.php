...
<!--<![endif]-->
    <center style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #f5f7fa;" class="wrapper">
      <table style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 600px;" class="header centered">
        <tbody><tr>
          <td style="padding: 0;vertical-align: top;">
            <table align="right" style="border-collapse: collapse;border-spacing: 0;" class="preheader">
              <tbody><tr>
                <td style="padding: 0;vertical-align: top;padding-bottom: 4px;padding-top: 13px;text-align: right;width: 280px;letter-spacing: 0.01em;line-height: 17px;font-weight: 400;font-size: 11px;" class="emb-logo-padding-box">
                  <div style="font-size: 1px;line-height: 2px;width: 100%;" class="spacer">&nbsp;</div>
            ...
            <table align="left" style="border-collapse: collapse;border-spacing: 0;">
              <tbody><tr>
                <td style="padding: 0;vertical-align: top;mso-line-height-rule: at-least;width: 280px;padding-top: 13px;padding-bottom: 4px;" class="logo emb-logo-padding-box">
                  <div align="left" id="emb-email-header" style="font-weight: 700;font-family: Avenir,sans-serif;color: #555;font-size: 0px !important;line-height: 0 !important;" class="logo-left"><a href="http://igt.createsend1.com/t/i-l-ijfjkl-l-r/" style="text-decoration: none;transition: opacity 0.2s ease-in;color: #555;" target="_blank"><img width="107" height="102" alt="iWaNaTrip" src="{!! url(env('AWS_PUBLIC_URL').'images/img/index-logo.png')!!}" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 107px;"></a></div>
                </td>
              </tr>
            </tbody></table>
          </td>
          ...
          <table style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;" class="centered">
            ...
            <h2 style="font-style: normal;font-weight: 700;Margin-bottom: 0;Margin-top: 0;font-size: 24px;line-height: 32px;font-family: &quot;Open Sans&quot;,sans-serif;color: #44a8c7;text-align: center;">Bienvenido a iWaNaTrip.com</h2><p style="font-style: normal;font-weight: 400;Margin-bottom: 24px;Margin-top: 16px;font-size: 15px;line-height: 24px;font-family: &quot;Open Sans&quot;,sans-serif;color: #60666d;text-align: center;">Gracias por dejar tu Review. Para verificar tu cuenta haz click </p>{!! $intro . link_to('/getConfirmReview/' . $confirmation_code, $link) !!}
            ...
            <div align="center" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: &quot;Open Sans&quot;,sans-serif;color: #60666d;" class="image">
              <a href="http://igt.createsend1.com/t/i-l-ijfjkl-l-y/" style="transition: opacity 0.2s ease-in;color: #5c91ad;" target="_blank"><img width="600" height="293" alt="iWaNaTrip" src="{!! url(env('AWS_PUBLIC_URL').'images/img/extra-pag-1b.png')!!}" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 900px;"></a>
            </div>
            ...
            <h2 style="font-style: normal;font-weight: 700;Margin-bottom: 0;Margin-top: 0;font-size: 16px;line-height: 24px;font-family: &quot;Open Sans&quot;,sans-serif;color: #44a8c7;text-align: center;" class="size-16">Lo que está por venir!!</h2>
          ...
          <table width="602" style="border-collapse: collapse;border-spacing: 0;font-size: 1px;line-height: 1px;background-color: #dddee1;Margin-left: auto;Margin-right: auto;" class="border">
            <tbody><tr style="font-size: 1px;line-height: 1px;background-color: #e3e3e3;height: 1px;" class="border">
              <td style="padding: 0;vertical-align: top;font-size: 1px;line-height: 1px;background-color: #dddee1;width: 1px;" class="border">&#8203;</td>
          ...
          <table style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;" class="centered">
            ...
            <div align="center" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: &quot;Open Sans&quot;,sans-serif;color: #60666d;" class="image">
              <img width="252" height="139" alt="" src="{!! url(env('AWS_PUBLIC_URL').'images/img/galapagos2.jpg')!!}" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 480px;">
            </div>
          ...
          <table style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;" class="centered">
            ...
            <div align="center" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: &quot;Open Sans&quot;,sans-serif;color: #60666d;" class="image">
              <img width="252" height="123" alt="" src="{!! url(env('AWS_PUBLIC_URL').'images/img/extra-pag-1c.png')!!}" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 480px;">
            </div>
          ...
          <table style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;" class="centered">
            ...
            <div align="center" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: &quot;Open Sans&quot;,sans-serif;color: #60666d;" class="image">
              <img width="252" height="189" alt="" src="{!! url(env('AWS_PUBLIC_URL').'images/img/Quito.jpg')!!}" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 480px;">
            </div>
                ...
                <td style="padding: 0;vertical-align: top;color: #b9b9b9;font-size: 12px;line-height: 22px;max-width: 200px;mso-line-height-rule: at-least;">
                  <div class="sharing">
                    <div style="Margin-bottom: 5px;">
                      <!--[if !mso]--><a rel="cs_facebox" left-align-text="true" href="/t/i-fb-ijfjkl-l-j/?act=wv" style="font-family: &quot;Open Sans&quot;,sans-serif;transition: opacity 0.2s ease-in;color: #ffffff;background-image: url(https://i3.createsend1.com/static/eb/master/03-fresh/imgf/fblike.png);background-repeat: no-repeat;background-size: 200px 56px;border-radius: 2px;display: block;font-size: 11px;font-weight: bold;line-height: 11px;padding: 8px 11px 7px 28px;text-align: left;text-decoration: none;background-color: #7b7c7d;" class="fblike" cs_likeurl="/t/i-fb-ijfjkl-l-j/?act=like" target="_blank">
                        Like
                      </a><!--[endif]-->
                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://igt.createsend1.com/t/i-fb-ijfjkl-l-j/" style="width:85px" arcsize="8%" fill="t" stroke="f"><v:fill type="tile" src="https://i3.createsend1.com/static/eb/master/03-fresh/imgf/fblike.png" color="#7B7C7D"></v:fill><v:textbox style="mso-fit-shape-to-text:t" inset="27px,7px,0,6px"><p style="font-size:11px;line-height:11px;color:#FFFFFF;font-family:sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:-1px">                        Like                      </p></v:textbox></v:roundrect><![endif]--></div>
                    <div style="Margin-bottom: 5px;">
                      <!--[if !mso]--><a left-align-text="true" href="http://igt.createsend1.com/t/i-tw-ijfjkl-l-t/" style="font-family: &quot;Open Sans&quot;,sans-serif;transition: opacity 0.2s ease-in;color: #ffffff;background-image: url(https://i4.createsend1.com/static/eb/master/03-fresh/imgf/tweet.png);background-repeat: no-repeat;background-size: 200px 56px;border-radius: 2px;display: block;font-size: 11px;font-weight: bold;line-height: 11px;padding: 8px 11px 7px 28px;text-align: left;text-decoration: none;background-color: #7b7c7d;" class="tweet" target="_blank">
                        Tweet
                      </a><!--[endif]-->
                    ...
                    <div style="Margin-bottom: 5px;">
                      <!--[if !mso]--><a left-align-text="true" href="http://igt.forwardtomyfriend.com/i-l-2AD73FFF-ijfjkl-l-i" style="font-family: &quot;Open Sans&quot;,sans-serif;transition: opacity 0.2s ease-in;color: #ffffff;background-image: url(https://i6.createsend1.com/static/eb/master/03-fresh/imgf/forward.png);background-repeat: no-repeat;background-size: 200px 56px;border-radius: 2px;display: block;font-size: 11px;font-weight: bold;line-height: 11px;padding: 8px 11px 7px 28px;text-align: left;text-decoration: none;background-color: #7b7c7d;" class="forwardtoafriend" target="_blank">
                        Forward
                      </a><!--[endif]-->
