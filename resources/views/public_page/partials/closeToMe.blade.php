...
<div id="x2">
    ...
    <div style=" margin-bottom: 0;" class="shortcode-banner style-animated iso-item eventInd filter-atracciones filter-alls" >
        <article class="post">
            <figure><img src="{!! url(env('AWS_PUBLIC_URL').'images/icon/'.$atracc->filename) !!}" alt=""></figure>
    ...
    @foreach ($Inspiration as $Inspir)
              ...
              <div class="iso-item filter-alls  filter-inspire ">
                                <article class="post">
                                    <a class="image soap-mfp-popup hover-style3" href="{!! url(env('AWS_PUBLIC_URL').'images/fullsize/'.$Inspir->filename) !!}">
                                        <img src="{!! url(env('AWS_PUBLIC_URL').'images/icon/'.$Inspir->filename) !!}" alt="">
    ...
    <div style=" margin-bottom: 0;" class="shortcode-banner style-animated iso-item eventInd filter-eventos filter-alls" >
        <article class="post">
            <figure><img src="{!! url(env('AWS_PUBLIC_URL').'images/icon/'.$event->filename) !!}" alt=""></figure>
    ...
    <div style=" margin-bottom: 0;" class="shortcode-banner style-animated iso-item eventInd filter-eventos filter-alls" >
        <article class="post">
            <figure><img src="{!! url(env('AWS_PUBLIC_URL').'images/icon/'.$event->filename) !!}" alt="{!!$event->nombre_servicio!!}"></figure>
            @if(session('device')!='mobile')
            <div class="shortcode-banner-inside" style=" width: 108%;">
                @else
                <div class="shortcode-banner-inside" style=" width: 112%;">
    ...
    <div style=" margin-bottom: 0;" class="shortcode-banner style-animated iso-item eventInd filter-promo filter-alls" >
        <article class="post">
            <figure><img src="{!! url(env('AWS_PUBLIC_URL').'images/icon/'.$promo->filename) !!}" alt=""></figure>
            @if(session('device')!='mobile')
            <div class="shortcode-banner-inside" style=" width: 108%;">
                @else
                <div class="shortcode-banner-inside" style=" width: 112%;">
