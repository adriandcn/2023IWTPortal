...
<head>
    <!-- Page Title -->
    <title>iWaNaTrip - |{{(session('locale') == 'es' )?" Ecuador Turismo | Ferry Galápagos | Ofertas Ecuador | Reservas online":"  Ecuador Travel | Ferry Galapagos | Ecuador deals |Online reservations"}}</title>
		...
		<div class="h-600x h-sm-auto">
			<div class="h-2-3 h-sm-auto oflow-hidden">
				...
				<div class="pb-5 pr-5 pr-sm-0 float-left float-sm-none w-2-3 w-sm-100 h-100 h-sm-300x">
					<a class="pos-relative h-100 dplay-block" href="https://iwannatrip.com/DayTrips">

						<div style="background: url({!!asset('/onlinetickets/uploads/44cotopaxi-ecuador-condortrekk-expeditions-ecuador-movil2-1.jpg')!!});
    background-size: auto;
background-size: cover;" class="img-bg bg-1 bg-grad-layer-6"></div>


						<div class="abs-blr color-white p-20 bg-sm-color-7">
							<h3 class="mb-15 mb-sm-5 font-sm-13"><b>{{(session('locale') == 'es' )?"Tours & DayTrips seleccionados para tí ":"Tours & things to do hand-picked by our insiders "}} </b></h3>
							<ul class="list-li-mr-20">
								<li>by <span class="color-primary"><b>iWaNaTrip.com</b></span> 2020</li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 col-lg-8">
					<h1 class="p-title"  style="font-size: 37px !important;"><b>{{(session('locale') == 'es' )?"Ecuador Turismo":"Tourism Ecuador"}}</b></h1>
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<a class="oflow-hidden pos-relative mb-20 dplay-block" href="https://iwannatrip.com/tour/Tour-diario-isla-Pinz%C3%B3n---Salida-desde-Santa-Cruz---Gal%C3%A1pagos/74/39">
								<div class="wh-100x abs-tlr"><img src="{!!asset('/onlinetickets/uploads/39WhatsApp Image 2019-01-16 at 11.05.57 PM.jpeg')!!}" alt=""></div>
								<div class="ml-120 min-h-100x">
					...
					<div class="row">
                        ...
                        <a href="{!!asset('/DayTripsVolcanes')!!}">
							<img src="{!!asset('/onlinetickets/uploads/44cotopaxi-ecuador-condortrekk-expeditions-ecuador-movil2-1.jpg')!!}" alt="volcanoes">
					...
					<div class="pl-20 pl-md-0">
						...
						<div class="mtb-50">
                            ...
                            <a class="oflow-hidden pos-relative mb-20 dplay-block" href="{!!asset('/tour/The-tunnels-daytrip-(Isabela---Galapagos)/2107/37')!!}">
								<div class="wh-100x abs-tlr"><img src="{!!asset('/onlinetickets/uploads/3724899869_1736560619710170_7265213013221685588_n.jpg')!!}" alt="costa"></div>
								<div class="ml-120 min-h-100x">
                            ...
                            <a class="oflow-hidden pos-relative mb-20 dplay-block" href="{!!asset('/DayTripsVolcanes')!!}">
								<div class="wh-100x abs-tlr"><img src="{!!asset('/onlinetickets/uploads/45cayambe5-movil-1.jpg')!!}" alt="volcanos"></div>
								<div class="ml-120 min-h-100x">
