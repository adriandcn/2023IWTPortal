    ...
    <div class="section">
        <div class="container">
            <div class="heading-box">
                <h2 class="box-title">Instagram</h2>
            </div>
            <div class="block row">
                <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="box-title">
                        {{(session('locale') == 'es')?'Inspirame Ecuador con ':'Inspire me Ecuador with '}}
                        <span class="skin-color">iWaNaTrip</span>
                    </h2>
                    <br>
                </div>
                <div class="col-lg-12">
                    ...
                    <!--     <div class="post-filters">
                        ...
                        <div class="iso-container iso-col-4 style-masonry">
                            @if(isset($images)) @foreach($images as $image)
                                <div class="iso-item single-width filter-all filter-logo">
                                    <article class="post">
                                        <a class="image hover-style3" href="{{$image->url_redirect}}">
                                            <img src="{{$image->icon_path}}" alt="">
                        ...
                        <div class="item">
                            <div class="Instagram-card">
                                <div class="Instagram-card-image">
                                    <a href="" onclick="setFullImage('{{ $image->full_path }}')" data-toggle="modal" data-target="#form-img-full">
                                        <img src= "{{ $image->icon_path }}" height=600px/>
                                    </a>
                                </div>
                                <div class="Instagram-card-content">
                                    <p class="Likes">
                                    ...
                                    <p>
                                        {{ ($media['caption'] != null)?str_limit($image->descripcion,60):'' }}
                                    </p>
                                    <hr>
                                </div>
                            </div>
