...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        <!-- Page Title -->
        <title>iWaNaTrip | {{ trans('booking/labels.label45')}}</title>
    ...
    <body class="woocommerce">
        ...
        <div id="page-wrapper">
            ...
            <ul class="breadcrumbs">
                <li class="active">{{ trans('booking/labels.label45')}}</li>
            </ul>
        </div>
            <script type='text/javascript'>
			   swal(
                          '{{ trans("booking/labels.label46")}}',
			  '{{ trans("booking/labels.label47")}}',
			  'error');
            </script>
        <section id="content">
            <div class="container">
                <div class="row" id="print">
                    <div id="main" class="col-sm-12 col-md-12">
                        <h1 class="entry-title" style="text-align:center;padding:4%;">{{ trans('booking/labels.label48')}}</h1>
                        <div class="product type-product text-center">
