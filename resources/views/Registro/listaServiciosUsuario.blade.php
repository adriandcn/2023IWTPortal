...
?>
    ...
    {!!$prefix!!}             <strong>{!!$operadorName!!}</strong>
     ...
     <div id="title-box-header-navigation">
       ...
       <strong><img src="{!! url(env('AWS_PUBLIC_URL').'images/img/flecha-1.png')!!}" height="15px" width="15px" /> Mi info </strong></a>
               <a class="button-step4" onclick="window.location.href = '{!!asset('/userservice')!!}'">
       <strong><img src="{!! url(env('AWS_PUBLIC_URL').'images/img/flecha-1.png')!!}" height="15px" width="15px" /> Agregar servicio </strong></a>
    ...
    <div class="wrapper uwa-font-aa">
        ...
        <div id="table_{!!$servicios->id!!}" class="servicio-usuario-detalle">
            ...
            <table class="tabla-servicio-usuario-detalle">
                ...
                <td id='change'>
                    <img src="{!! url(env('AWS_PUBLIC_URL').'images/img/flecha-1.png')!!}" height="10px" width="10px" />
