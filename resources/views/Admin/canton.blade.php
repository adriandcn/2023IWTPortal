...
<div class="row-step4">
   ...
   <a class="button-step4" onclick="window.location.href = '{!!asset('/servicios')!!}'">
       <strong><img src="{!! url('https://iwannatrip.s3.us-east-1.amazonaws.com/images/img/flecha-1.png')!!}" height="15px" width="15px" /> Paso 1 </strong></a>
...
<script>
    $(document).ready(function () {
        ...
        GetDataAjaxProvincias("{!!asset('/getProvinciasCanton')!!}");
    });
