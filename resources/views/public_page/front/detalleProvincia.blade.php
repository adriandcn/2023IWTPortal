        ...
        <section id="content">
            <div class="container">
                                ...
                                <div class="product-images col-sm-5 box-lg  ">
                                  ...
                                  @foreach ($imagenes as $imagen)
                                     ...
                                     <a href="{!! url(env('AWS_PUBLIC_URL').'images/fullsize/'.$imagen->filename) !!}" class="soap-mfp-popup">
                                        <img src="{!! url(env('AWS_PUBLIC_URL').'images/fullsize/'.$imagen->filename) !!}" alt="">
                ...
                @for ($x = 0; $x < count($visitados); $x++)
                        ...
                        <?php list($width, $height) = getimagesize(url(env('AWS_PUBLIC_URL').'images/icon/' . $visitados[$x]->filename)); ?>
                            @if($height>500 && $height<600)
                                @if($flag==0)
                            <li class="product col-sms-6 col-sm-6 col-md-4 box">
                                    <a class="product-image" href="#">
                                        <div class="first-img">
                                            <img alt="" src="{{ url(env('AWS_PUBLIC_URL').'images/icon/'.$visitados[$x]->filename)}}">
                                        </div>
                                        @if(isset($visitados[$x+1])&& $visitados[$x+1]->id_auxiliar==$visitados[$x]->id_auxiliar)
                                        <div class="back-img">
                                            <img alt="" src="{{ url(env('AWS_PUBLIC_URL').'images/icon/'.$visitados[$x+1]->filename)}}">
                                        </div>
                                       <?php $flag=1;?>
                                        @endif
                                    </a>
