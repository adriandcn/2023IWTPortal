                    ...
                    <div class="post-wrapper">
                        ...
                        <div class="iso-container iso-col-4 style-masonry">
                            <div class="iso-item double-width filter-all filter-logo">
                                <article class="post">
                                    <a class="image soap-mfp-popup hover-style3" href="{{ url(env('AWS_PUBLIC_URL').'images/icon/5709-08-2015-23.jpg')}}">
                                        <img src="{{ url(env('AWS_PUBLIC_URL').'images/fullsize/5709-08-2015-23.jpg')}}" alt="">
                            ...
                            <div class="iso-item filter-all filter-website">
                                <article class="post">
                                    <a class="image soap-mfp-popup hover-style3" href="{{ url(env('AWS_PUBLIC_URL').'images/fullsize/5709-08-2015-25.jpg')}}">
                                        <img src="{{ url(env('AWS_PUBLIC_URL').'images/icon/5709-08-2015-25.jpg')}}" alt="">
                                        <span class="image-extras"></span>
                                    </a>
                                </article>
                            </div>
