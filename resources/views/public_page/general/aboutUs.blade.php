...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        <!-- Page Title -->
        <title>iWanaTrip About Us| Vive la experiencia Ecuador</title>
        ...
        <meta name="description" content="iWanaTrip.com About Us">
        ...
        <section id="content">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-8">
                            <div class="post-slider style1 owl-carousel box">
                                <a href="{{ url(env('AWS_PUBLIC_URL').'images/img/portada_face_iwanatrip_02.jpg')}}" class="soap-mfp-popup">
                                    <img src="{{ url(env('AWS_PUBLIC_URL').'images/img/portada_face_iwanatrip_02.jpg')}}" alt="">
                                </a>
                                <a href="{{ url(env('AWS_PUBLIC_URL').'images/img/portada_face_iwanatrip_01.jpg')}}" class="soap-mfp-popup">
                                    <img src="{{ url(env('AWS_PUBLIC_URL').'images/img/portada_face_iwanatrip_01.jpg')}}" alt="">
                                </a>
                                <a href="{{ url(env('AWS_PUBLIC_URL').'images/img/portada_face_iwanatrip_04.jpg')}}" class="soap-mfp-popup">
                                    <img src="{{ url(env('AWS_PUBLIC_URL').'images/img/portada_face_iwanatrip_04.jpg')}}" alt="">
                                </a>
                            </div>
                        </div>
            ...
            <div class="section">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <p>iWaNaTrip es un espacio de busqueda para la red viajeros de todo el mundo, permite compartir el contenido de forma sencilla a traves de internet.</p>
                            <p>Nosotros ponemos a la disposicion del viajero informacion no solo de las atracciones mas visitadas sino tambien sitios que nunca encontrarias en los libros ni en internet permitiendote descubrir sitios increhibles en tu viaje.</p>
                        </div>
                        <div class="col-sm-6">
                            <p>Nuestros sofisticados algoritmos de desarrollo permiten posicionar y recomendar los sitios acordes a los intereses del viajero.</p>
                            <p>Los operadores turisticos tienen la capacidad de manejar su propia publicidad y su nivel de ranking el cual le permite ser encontrado por miles de turistas a nivel mundia.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row add-circle-box-line">
                            <div class="col-sm-6 col-md-3 box">
                                <div class="counters-box style1">
                                    <div class="icon-wrap">
                                        <img src="{{ url(env('AWS_PUBLIC_URL').'images/img/check.png')}}" alt="">
                                    </div>
                                    <dl>
                            ...
                            <div class="col-sm-6 col-md-3 box">
                                <div class="counters-box style1">
                                    <div class="icon-wrap">
                                        <img src="{{ url(env('AWS_PUBLIC_URL').'images/img/coffee.png')}}" alt="">
                                    </div>
                                    <dl>
                            ...
                            <div class="col-sm-6 col-md-3 box">
                                <div class="counters-box style1">
                                    <div class="icon-wrap">
                                        <img src="{{ url(env('AWS_PUBLIC_URL').'images/img/heart.png')}}" alt="">
                                    </div>
                                    <dl>
                            ...
                            <div class="col-sm-6 col-md-3 box">
                                <div class="counters-box style1">
                                    <div class="icon-wrap">
                                        <img src="{{ url(env('AWS_PUBLIC_URL').'images/img/cog.png')}}" alt="">
                                    </div>
                                    <dl>
