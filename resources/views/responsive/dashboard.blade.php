...
<link rel="apple-touch-icon" href="{{ asset('images/favicon.png')}}" />
    ...
    <body class="woocommerce">
           ...
           <ul class="breadcrumbs" id="dashboard11" style="display:none;">
            ...
            <ul class="breadcrumbs" id="dashboard12" style="display:none;">
                <li><a href="https://www.iguanatrip.com/AdminEmails"  onclick="$('#target').LoadingOverlay('show')">Admin Emails2</a></li>
                <li><a href="https://www.iguanatrip.com/AdminEmails"  onclick="$('#target').LoadingOverlay('show')">https://www.iguanatrip.com/AdminEmails</a></li>
                <li class="active"> Admin Emails</li>
           </ul>

            <ul class="breadcrumbs" id="dashboard12" style="display:none;">
                <li><a href="https://www.iguanatrip.com/XkZLMbcy9x"  onclick="$('#target').LoadingOverlay('show')">Admin Cupones</a></li>
                <li><a href="https://www.iguanatrip.com/XkZLMbcy9x"  onclick="$('#target').LoadingOverlay('show')">https://www.iguanatrip.com/XkZLMbcy9x</a></li>
                <li class="active"> Admin Cupones</li>
           </ul>
                        ...
                        <div class="tab-container dashboard row">
                            ...
                            <div class="col-sm-3 col-md-3">
                                ...
                                <ul class="tabs arrow-circle size-medium box">
                                    ...
                                    <li>
                                        <a style="border: 0px;margin-left:1%;text-align: left; padding-top: 4%;" href="{!!asset('/suscripciones')!!}" class="btn btn-sm style4" target="_blank">
                                            {{trans('front/dashboard.menu5')}}
                                        </a>
                                    </li>
                                    <li>
                                        <a style="border: 0px;margin-left:1%;text-align: left; padding-top: 4%;" href="{!!asset('/suscription-to-user')!!}" class="btn btn-sm style4" target="_blank">
                                            {{trans('front/dashboard.menu6')}}
                                        </a>
                                    </li>


									<li>
                                        <a style="border: 0px;margin-left:1%;text-align: left; padding-top: 4%;" href="{!!asset('/booking-email-list')!!}" class="btn btn-sm style4" target="_blank">
                                            {{trans('front/dashboard.menu7')}}
                                        </a>
                                    </li>
									 <li>
                                        <a style="border: 0px;margin-left:1%;text-align: left; padding-top: 4%;" href="{!!asset('/detalleServiciosAdmin27')!!}" class="btn btn-sm style4" target="_blank">
                                           Admin Pantalla negra
                                        </a>
                                    </li>
                                    <li>
                                        <a style="border: 0px;margin-left:1%;text-align: left; padding-top: 4%;" href="{!!asset('/tours/serviciooperador/33/1')!!}" class="btn btn-sm style4" target="_blank">
                                           Admin SEO Tours
                                        </a>
                                    </li>

									<li>
                                        <a style="border: 0px;margin-left:1%;text-align: left; padding-top: 4%;" href="{!!asset('/adminReview')!!}" class="btn btn-sm style4" target="_blank">
                                            Crear Review fake
                                        </a>
                                    </li>

										<li>
                                        <a style="border: 0px;margin-left:1%;text-align: left; padding-top: 4%;" href="https://www.iguanatrip.com/AdminEmails" class="btn btn-sm style4" target="_blank">
                                            Admin Emails
                                        </a>
                                    </li>


                                    <li id="cupones" style="display:none;">
                                        <a style="border: 0px;margin-left:1%;text-align: left; padding-top: 4%;" href="https://iwannatrip.com/adminDeliveryIWT/cupones" class="btn btn-sm style4" target="_blank">
                                            Admin Cupones
                                        </a>
                                    </li>

                                    <li id="correos" style="display:none;">
                                        <a style="border: 0px;margin-left:1%;text-align: left; padding-top: 4%;" href="https://iwannatrip.com/adminDeliveryIWT/correos" class="btn btn-sm style4" target="_blank">
                                            Admin Correos
                                        </a>
                                    </li>

                                    <li id="pagos" style="display:none;">
                                        <a style="border: 0px;margin-left:1%;text-align: left; padding-top: 4%;" href="https://iwannatrip.com/adminDeliveryIWT/pagos" class="btn btn-sm style4" target="_blank">
                                            Admin Pagos
                                        </a>
                                    </li>
