...
{!! HTML::style('css/base/mobileBase.css') !!}
<div style='display:none'>
    <img src="{!! url(env('AWS_PUBLIC_URL').'images/img/x.png')!!}" alt='' />
</div>
<style>
    #simplemodal-container a.modalCloseImg {
        background:url("{!! url('https://iwannatrip.s3.us-east-1.amazonaws.com/images/img/x.png')!!}") no-repeat;
        ...
        <tbody><tr>
          ...
          <table class="one-col-feature-bg" style="border-collapse: collapse;border-spacing: 0;width: 100%;">
            ...
            <div class="image" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: Ubuntu,sans-serif;color: #e0dce0;" align="center">
              <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 900px;" src="https://iwannatrip.s3.us-east-1.amazonaws.com/images/img/Quito.jpg" alt="" width="600" height="376" />
            </div>
          ...
          <table class="two-col-bg" style="border-collapse: collapse;border-spacing: 0;width: 100%;">
            ...
            <div class="image" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: Ubuntu,sans-serif;color: #e0dce0;" align="center">
              <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 480px;" src="https://iwannatrip.s3.us-east-1.amazonaws.com/images/img/viajeros-1.png" alt="" width="290" height="142" />
            </div>
            ...
            <div class="image" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: Ubuntu,sans-serif;color: #e0dce0;" align="center">
              <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 480px;" src="https://iwannatrip.s3.us-east-1.amazonaws.com/images/img/extra-pag-1a.png" alt="" width="290" height="142" />
            </div>
          ...
          <table class="one-col-bg" style="border-collapse: collapse;border-spacing: 0;width: 100%;">
            ...
            <h3 style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;color: #80bfc4;text-align: center;">
                 <a onclick="RenderPartialGeneric('reusable.invitar_amigo')" href="#"><img src="{{ url(env('AWS_PUBLIC_URL').'images/img/amigo-2.png')}}"></a>
