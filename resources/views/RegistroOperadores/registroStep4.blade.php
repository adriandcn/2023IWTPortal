...
$usuarioServicio->face_image_desk = '';
$usuarioServicio->face_image_mobile = '';

$usuarioServicio->meta_description_esp = '';
$usuarioServicio->meta_description_eng = '';
$usuarioServicio->h1_eng = '';
$usuarioServicio->h1_esp = '';
$usuarioServicio->url_esp = '';
$usuarioServicio->url_eng = '';
...
$usuarioServicio->id_catalogo_eventos = '';

$usuarioServicio->key_words = '';
$usuarioServicio->key_words_eng = '';
...
$usuarioServicio->face_image_desk = trim($detalles->face_image_desk);
$usuarioServicio->face_image_mobile = trim($detalles->face_image_mobile);

$usuarioServicio->url_esp = trim($detalles->url_esp);
$usuarioServicio->url_eng = trim($detalles->url_eng);
...
$usuarioServicio->meta_description_esp =  $detalles->meta_description_esp;
$usuarioServicio->meta_description_eng = $detalles->meta_description_eng;
$usuarioServicio->h1_eng = $detalles->h1_eng;
$usuarioServicio->h1_esp = $detalles->h1_esp;
...
$usuarioServicio->fuente = $detalles->fuente;
$usuarioServicio->id_catalogo_eventos = $detalles->id_catalogo_eventos;

$usuarioServicio->key_words = $detalles->key_words;
$usuarioServicio->key_words_eng = $detalles->key_words_eng;
$usuarioServicio->nombre_servicio_eng = $detalles->nombre_servicio_eng;
        ...
        <div id="part-1-form">
            <div id="principal-data">
                <div class="form-group-1">
                    {!!Form::label('nombre_servicio_1', 'Nombre Servicio(M Title)', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('nombre_servicio', $usuarioServicio->nombre_servicio, array('class'=>'inputtext chng','placeholder'=>'Nombre del Servicio'))!!}
                </div>

                <div class="form-group-1">
                    {!!Form::label('nombre_servicio_eng', 'Nombre Servicio Eng (M Title Eng) ', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('nombre_servicio_eng', $usuarioServicio->nombre_servicio_eng, array('class'=>'inputtext chng','placeholder'=>'Nombre del Servicio'))!!}
                </div>

                <div class="form-group-1">
                    {!!Form::label('url_esp', 'URL ESP', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('url_esp', $usuarioServicio->url_esp, array("title"=>"URL en español",'class'=>'inputtext chng','placeholder'=>'url esp'))!!}
                </div>
                  <div class="form-group-1">
                    {!!Form::label('url_eng', 'URL ENG', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('url_eng', $usuarioServicio->url_eng, array("title"=>"URL inglés",'class'=>'inputtext chng','placeholder'=>'URL eng'))!!}
                </div>
                <div class="form-group-1">
                    {!!Form::label('key_words', 'KEY WORDS',array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('key_words', $usuarioServicio->key_words, array("title"=>"Palabras clave o referencias separadas por comas",'class'=>'inputtext chng','placeholder'=>'keyword1, keyword2'))!!}
                </div>
                  <div class="form-group-1">
                    {!!Form::label('key_words_eng', 'KEY WORDS_eng', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('key_words_eng', $usuarioServicio->key_words_eng, array("title"=>"Palabras clave o referencias separadas por comas",'class'=>'inputtext chng','placeholder'=>'keyword1, keyword2'))!!}
                </div>


                <div class="form-group-1">
                    {!!Form::label('meta_description_esp', 'Meta Description Español', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('meta_description_esp', $usuarioServicio->meta_description_esp, array("title"=>"Descripcion que aparece en google",'class'=>'inputtext chng','placeholder'=>'descripción'))!!}
                </div>

                <div class="form-group-1">
                    {!!Form::label('meta_description_eng', 'Meta Description English', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('meta_description_eng', $usuarioServicio->meta_description_eng, array("title"=>"Descripcion que aparece en google",'class'=>'inputtext chng','placeholder'=>'description'))!!}
                </div>

                <div class="form-group-1">
                    {!!Form::label('h1_esp', 'h1 español',array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('h1_esp', $usuarioServicio->h1_esp, array("title"=>"h1 español",'class'=>'inputtext chng','placeholder'=>'h1 español'))!!}
                </div>
                <div class="form-group-1">
                    {!!Form::label('h1_eng', 'h1 english', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('h1_eng', $usuarioServicio->h1_eng, array("title"=>"h1 ingles",'class'=>'inputtext chng','placeholder'=>'h1 ingles'))!!}
                </div>

                <div class="form-group-1">
                    {!!Form::label('face_image_desk', 'facebook image desk', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('face_image_desk', $usuarioServicio->face_image_desk, array("title"=>"face_image_desk",'class'=>'inputtext chng','placeholder'=>'face_image_desk'))!!}
                </div>

                <div class="form-group-1">
                    {!!Form::label('face_image_mobile', 'facebook image mobile', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('face_image_mobile', $usuarioServicio->face_image_mobile, array("title"=>"face_image_mobile",'class'=>'inputtext chng','placeholder'=>'face_image_mobile'))!!}
                </div>
                ...
                <div class="form-group-1">
                    {!!Form::label('horarios', 'Horario atencion', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('horario', $usuarioServicio->horario, array("title"=>"Horario de atenci�n",'class'=>'inputtext chng','placeholder'=>'Lunes a Viernes de 7AM a 8PM'))!!}
                </div>
                <div class="form-group-1">
                    {!!Form::label('Fuente', 'Fuente Informacion', array('class'=>'control-label','id'=>'iconFormulario-step4'))!!}
                    {!!Form::text('fuente', $usuarioServicio->fuente, array('class'=>'inputtext chng','placeholder'=>'Fuente'))!!}
                </div>

                <div class="form-group">
             {!!Form::label('id_catalogo_eventos', 'Tipo de Evento', array('id'=>'iconFormulario-step2-popup'))!!}
            <select name="id_catalogo_eventos" id="id_catalogo_eventos" class="input-text chng" style="height: 40px;width: 100%;">
                <option value="0"> Seleccionar </option>
                @foreach($tipoEventos as $tipos)
                    @if($usuarioServicio->id_catalogo_eventos == $tipos->id_catalogo_eventos)
                    <option value="{!! $tipos->id_catalogo_eventos !!}" selected >{!!$tipos->nombre_catalogo_eventos!!}</option>
                    @else
                    <option value="{!! $tipos->id_catalogo_eventos !!}"  >{!!$tipos->nombre_catalogo_eventos!!}</option>
                    @endif
                @endforeach
            </select>
                ...
                <div id="evento"><a class="button-step4" title="Esta opci�n es orientada a servicios turísticos de viajes y transporte. Por ejemplo tu servicio es una agencia de viajes y tienes varios itinerarios Trip Cotopaxi, Trip Amazonía o si eres un transporte podrás especificar la ruta de tu servicio." onclick="RenderPartialGeneric('reusable.createNewItinerario', {!!$usuarioServicio->id!!})" href="#"> <h1 class="h1-agregar">+</h1> Agregar tour o itinerario</a></div>
...
-->
        ...
        <div id="part-1-form">
          ...
          <!--    <div class="box-content-button-1">
                <a class="button-1" title="Vista previa" onclick="window.location.href ='/tokenDc$rip/{!!$usuarioServicio->id!!}'" href="#">Vista Previa</a>
            </div>  -->
        </div>
       ...
       <!-- <link href="https://bookiw.iwannatrip.com/index.php?controller=pjFront&action=pjActionLoadCss&cid=3" type="text/css" rel="stylesheet" />
        <script type="text/javascript" src="https://bookiw.iwannatrip.com/index.php?controller=pjFront&action=pjActionLoad&cid=3&view=2"></script>-->
        </div>
    </div>
       ...
       <a href="#"
          onclick="RenderBookingCalendario({!!$usuarioServicio->id_usuario_operador!!}, {!!$usuarioServicio->id!!},{!!$calendar->id!!})" >
           <h3 style="color:white;font-weight: bold;font-size: 1vw !important;"> {!!$calendar->content!!} </h3>
                ...
                <link href="https://bookiw.iwannatrip.com/index.php?controller=pjFront&action=pjActionLoadCss&cid={!!$calendar->id!!}" type="text/css" rel="stylesheet" />
                <script type="text/javascript" src="https://bookiw.iwannatrip.com/index.php?controller=pjFront&action=pjActionLoad&cid={!!$calendar->id!!}&view=1"></script>
