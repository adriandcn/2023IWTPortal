...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        <!-- Page Title -->
        <title>iWanaTrip Operator| Vive la experiencia Ecuador</title>
        ...
        <meta name="description" content="iWanaTrip.com Operator">
                ...
                <div class="row">
                    ...
                    <div id="main" class="col-sm-8 col-md-9">
                        <div class="box">
                            ...
                            <img src="{{ url(env('AWS_PUBLIC_URL').'images/img/iwanaTrip.jpg')}}" alt="iWanaTrip">
