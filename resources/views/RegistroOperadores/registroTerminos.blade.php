...
<style>
    #simplemodal-container a.modalCloseImg {
        background:url("{!! url('https://iwannatrip.s3.us-east-1.amazonaws.com/images/img/x.pngx.png')!!}") no-repeat;
...
?>
   ...
   <a class="button-step4" onclick="window.location.href = '{!!asset('/servicios')!!}'">
       <strong><img src="{!! url(env('AWS_PUBLIC_URL').'images/img/flecha-1.png')!!}" height="15px" width="15px" /> Paso 1 </strong></a>
...
<div align="center">
                    ...
                    <a href="eng"><img src="{{ url(env('AWS_PUBLIC_URL').'images/img/index-logo.png')}}" width="270" height="258" alt="IguanaTrip" /></a>
                </div>
        </div>
