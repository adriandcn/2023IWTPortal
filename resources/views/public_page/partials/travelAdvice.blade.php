                                                    ...
                                                    <div class="col-sms-8 col-sm-8 details">
													  ...
													  @if(session('locale') == 'es' )
														   <a href="https://iwannatrip.com/trip/Ruta-Mochilera/1122"><h3 class="title">Ruta Mochilera</h3></a>
															<?php $str = "Tu mochila y un presupuesto de 20 d�lares por d�a te llevar�n a explorar los diferentes mundos que ofrece Ecuador sin viajar grandes distancias. Descubre los fr�os paisajes de los Andes para luego adentrarte a la calurosa puerta de la Amazon�a y terminar con una relajante surf y exquisita comida en la playa." ?>
                                                            <p>{!!$str!!}</p>
                                        ...
                                        <div id="mapas ">
                                                        ...
                                                        <div class="col-sms-8 col-sm-8 details">
                                                            <?php $str20 = "Gal�pagos" ?>
                                                                <a href="https://iwannatrip.com/trip/Galapagos/1170">
																	...
																	@if(session('locale') == 'es' )
																	    <?php $str2 = "Es el para�so en la Tierra. Imagina la belleza de una isla del Pac�fico con aguas cristalinas color turquesa y paisajes alucinantes con la peque�a peculiaridad que est�n infestada de grandiosos animales por donde vayas. Com�nmente se cree que es muy caro viajar a las islas. Sin embargo, no es del todo cierto." ?>
																		<p>{!!$str2!!}</p>
									                              @else
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="image-box row animated">
														...
														@if(session('locale') == 'es' )
                                                            <?php $str20 = "Adrenal�na- Amazon�a" ?>
                                                                <a href="https://iwannatrip.com/trip/Adrenalina-Amazonia/1171">
                                                                    <h3 class="title">{!!$str20!!}</h3></a>
                                                                <?php $str2 = "La Amazon�a de Ecuador es una de las m�s biodiversas del planeta. Mientras caminas por senderos, exploras cavernas o simplemente navegas en uno de los cientos de r�os, apreciar la gran cantidad de animales y plantas. De la misma forma, sus espectaculares vistas y cascadas te pondr�n en contacto con la naturaleza en su m�ximo esplendor. " ?>
                                                                    <p>{!!$str2!!}</p>
														@else
                                                    ...
                                                    <div class="image-box row animated">
                                                        ...
                                                        <div class="col-sms-8 col-sm-8 details">
                                                            ...
                                                            <?php $str20 = "Lo mejor del Ecuador" ?>
                                                                <a href="https://iwannatrip.com/trip/Lo-Mejor-Del-Ecuador/1173">
                                                                    <h3 class="title">{!!$str20!!}</h3></a>
                                                                <?php $str2 = "Lo mejor de Ecuador se encuentra en probar un poquito de cada regi�n. Siente el fr�o los espectaculares paisajes de las monta�as. Vive la naturaleza y la biodiversidad al m�ximo en la Amazon�a. Rel�jate y aprende surf en las calurosas playas para finalmente ver la magnificencia del para�so en la Tierra: Las Islas Gal�pagos.  " ?>
                                                                    <p>{!!$str2!!}</p>
																	@else
