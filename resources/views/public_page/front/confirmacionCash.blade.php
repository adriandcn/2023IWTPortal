...
<link rel="apple-touch-icon" href="{{ asset('images/favicon.png')}}" />        
    ...
    <body class="woocommerce">
        ...
        <div id="page-wrapper">
            ...
            @include('public_page.reusable.banner', ['titulo' =>'Confirmacion Booking Cash'])  
            ...
            <div class="container">
                <div class="row" id="print">
                    <div id="main" class="col-sm-12 col-md-12">
                        ...
                        <div class="product type-product">
                            <div class="woocommerce-tabs tab-container vertical-tab clearfix box">
                                <div class="row" id="pdfprint">
                                    <div class="col-sm-6">
                                        <div class="woocommerce-billing-fields box" id="basic-table1">
                                            <h4>{{ trans('booking/labels.label6')}}</h4>

                                            <div class="form-group column-2 no-column-bottom-margin">
                                                <label style="padding-bottom:1%;">{{ trans('booking/labels.label1-1')}}</label>
                                                <input class="input-text full-width" placeholder="First name" type="text"
                                                       value="{!!$infoAgrupamiento[0]->nombre!!}" readonly="">
                                            </div>
                                            <div class="form-group column-2 no-column-bottom-margin">
                                                <label style="padding-bottom:1%;">{{ trans('booking/labels.label1-2')}}</label>
                                                <textarea class="input-text full-width" id='infoTour' rows="4" cols="50" readonly="" style="resize: none !important;">{!!$infoAgrupamiento[0]->descripcion!!}</textarea>
                                            </div>
                                            <div class="form-group column-2 no-column-bottom-margin">
                                            ...
                                            <div id="payment">
                                                ...
                                                <ul class="payment_methods methods box-sm">
                                                    <li class="payment_method_paypal">
                                                        <label>
                                                            {{ trans('booking/labels.label38')}}    
                                                            <!-- <img src='https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl={!!$infoReservas[0]->uuid!!}&choe=UTF-8' /> -->
                                                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQdNX4hBtGyYkdms_f198WCf7YN8SlvPKfGq2nQyR_-Dw0rcgX" width="30%;" height="10%;">
                                                        </label>
                                                    </li>
                                                </ul>
                                                <div class="clear"></div>
                        ...
                        <button class="btn btn-default" id="create_pdf">
                            {{ trans('booking/labels.label22')}}
                        </button>
                        <button class="btn btn-default" onclick="window.location.href ='{{ asset('/tour/'.$infoAgrupamiento[0]->nombre.'/'.$idUsuarioServicio.'/'.$infoAgrupamiento[0]->id)}}'">{{ trans('booking/labels.label23')}}</button>    
...
<script> 
    window.onload = function () { 
        sendMailBooking('{!!$infoReservas[0]->token_consulta!!}','Reservacion-{!!$infoReservas[0]->c_name!!}-{!!$infoPago[0]->fecha_pago!!}.pdf');        
    }
</script>   
