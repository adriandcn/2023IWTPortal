...
?>
   ...
   <a class="button-step4" onclick="window.location.href = '{!!asset('/servicios/serviciooperador')!!}/{{ $evento->id_usuario_servicio }}/{!!$servicio->id_catalogo_servicio!!}'">
       ...
       <strong><img src="{!! url(env('AWS_PUBLIC_URL').'images/img/flecha-1.png')!!}" height="15px" width="15px" /> Regresar </strong></a>
        ...
        <div id="part-1-form">
            ...
            <div id="secondary-data">
                <div id="promocion" style="margin-left: 145px">
                    ...
                    <a onclick="RenderPartialGenericFotografia('reusable.uploadImagePopUp', 4, {!!$evento->id_usuario_servicio!!}, {!!$evento->id!!})" href="#"><img src="{{ url(env('AWS_PUBLIC_URL').'images/img/fotograf.png')}}" style="width:111px"></a>
                </div>
            </div>
        </div>
    </div>
