            ...
            <div id="main">
                <div class="row">
                    <div class="col-md-6" style="margin-left: 25%">
                        <form method="POST" action="{{asset('/subscription')}}" accept-charset="UTF-8" role="form" class="form-bordered" id="formAdminsubscription">
                            <h4>{{trans('front/responsive.lblFormSubscription')}}</h4>
                            <div class="form-group">
                                <label>{{trans('front/responsive.lblSubscriptionType')}}</label>
                                @foreach($typesList as $type)
                                    <input type="checkbox" name="subscription_type[]" value="{{$type->id_subscription_type}}"> {{(session('locale') == 'es')?$type->type_name:$type->type_name_eng}}
                                @endforeach
                            </div>
                            <div class="form-group">
                                <input type="text" class="input-text full-width" id="atraction_name" name="atraction_name" placeholder="{{trans('front/responsive.placeHolderFormSubscriptionName')}}">
                            </div>
                            <div class="form-group">
                                <input type="email" class="input-text full-width" id="email" name="email" placeholder="{{trans('front/responsive.placeHolderFormSubscriptionEmail')}}">
                            </div>
                            <div class="form-group">
                                <input type="text" class="input-text full-width" id="phone" name="phone" placeholder="{{trans('front/responsive.placeHolderFormSubscriptionPhone')}}">
                            </div>
                            <div class="form-group">
                                <input type="text" class="input-text full-width" id="movil" name="movil" placeholder="{{trans('front/responsive.placeHolderFormSubscriptionMovil')}}">
                            </div>
                            <div class="form-group">
                                <input type="text" class="input-text full-width" id="payment" name="payment" placeholder="{{trans('front/responsive.placeHolderFormSubscriptionPay')}}">
                            </div>
                            <div class="form-group">
                                <input type="text" class="input-text full-width" id="payment_marketing" name="payment_marketing" placeholder="{{trans('front/responsive.placeHolderFormSubscriptionPayMarketing')}}">
                            </div>
                            <div class="form-group">
                                <input type="text" class="input-text full-width" id="subscription_time" name="subscription_time" placeholder="{{trans('front/responsive.placeHolderFormSubscriptionTime')}}">
                            </div>
                            <div class="form-group">
                                <input type="text" class="input-text full-width" id="date_ini" name="date_ini" placeholder="{{trans('front/responsive.placeHolderFormSubscriptionDateIni')}}">
                            </div>
                            <div class="form-group">
                                <input type="text" class="input-text full-width" id="date_end" name="date_end" placeholder="{{trans('front/responsive.placeHolderFormSubscriptionDateEnd')}}" readonly>
                            </div>
                            <div class="text-center" style="color: red;font-weight: bold;">
                                <div class="rowerrorSubscription">
                                    <br>
                                </div>
                                <br>
                            </div>
