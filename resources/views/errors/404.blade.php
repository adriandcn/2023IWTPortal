        ...
        <section id="content">
            <div class="container">
                <div id="main" class="col-md-10 col-lg-8">
                    ...
                    <hr class="color-light1 box-lg">
                    <a href="https://iwannatrip.com" class="btn btn-md style4 btn-go-back">Go Back</a>
                    <a href="https://iwannatrip.com/contactos" class="btn btn-md style4">Get Help</a>
                </div>
            </div>
        </section>
                    ...
                    <div class="copyright-area">
                        <nav class="secondary-menu">
                            <ul class="nav nav-pills">
                                <li><a href="https://iwannatrip.com">Home</a></li>

                            </ul>
                        </nav>
                        <div class="copyright">
                            &copy; 2017 iWaNaTrip.com <em>by</em> <a href="https://iwannatrip.com/">iWaNaTrip Group</a>
                        </div>
                    </div>
                </div>
            </div>
