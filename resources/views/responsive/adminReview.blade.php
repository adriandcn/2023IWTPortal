...
<body class="woocommerce">
    ...
    <div id="page-wrapper">
        ...
        @include('public_page.reusable.banner', ['titulo' =>'Registro re reviews'])
            ...
            <div id="main">
                ...
                <div class="row">
                    <div class="col-md-6" style="margin-left: 25%">
                        <form method="POST" action="" accept-charset="UTF-8" role="form" class="form-bordered" id="formAdminReview">
                            <h4>Registro de reviews</h4>
                            <div class="form-group">
                                <select name="agrupamiento" id="agrupamiento" class="form-control">
                                    <option value="">Seleccione un elemento</option>
                                    @foreach($agrupamientoList as $item)
                                        <option value="{{$item->id}}">{{$item->nombre}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <input type="text" class="input-text full-width" id="created_at" name="created_at" placeholder="Fecha">
                            </div>
                            <div class="form-group">
                                <input type="text" class="input-text full-width" id="name" name="name" placeholder="Tu nombre">
                            </div>
                            <div class="form-group">
                                <input type="email" class="input-text full-width" id="email" name="email" placeholder="Tu email">
                            </div>

                            <div class="form-group">
                                <div id="htmlTypeREview"></div>
                            </div>
                            
                            <div class="form-group">
                                <textarea class="input-text full-width" id="comentario" name="comentario" rows="5"></textarea>
                            </div>
                            <div class="form-group">
                                <a href="#" class="btn style1" onclick="saveAdminReview()">Guardar review</a>
                            </div>
