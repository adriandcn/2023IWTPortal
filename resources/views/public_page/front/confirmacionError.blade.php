...
<link rel="apple-touch-icon" href="{{ asset('images/favicon.png')}}" />
    ...
    <body class="woocommerce">
        ...
        <div id="page-wrapper">
            ...
            @include('public_page.reusable.banner', ['titulo' =>'Error Pago PayPal'])
            ...
            <div class="container">
                <div class="row" id="print">
                    <div id="main" class="col-sm-12 col-md-12">
                        ...
                        <p>
                                   <a  class="btn btn-default" href="https://iwannatrip.com/" style="text-align: center;font-weight: bold;margin-top: 5%;color: white;">{{ trans('booking/labels.label28')}}</a>
			</p>
