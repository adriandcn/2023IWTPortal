...
<html lang="en">
<head>
<title>Venus Responsive Website  | Contact :: w3layouts</title>
...
<!--custom css-->
	...
	<link rel="stylesheet" href="{{asset('/Jupiter/css/swipebox.css')}}">
<!--component-css-->
   ...
   <div class="details-grid con">
				<div class="details-shade ">
						<div class="details-right">
							...
							<h3>Ingresa tu denuncia</h3>
							<h4>No te quedes callado, ayudanos a ayudar!!.</h4>
            ...
            <div class="w3agile contact">
			     <div class="contact-form">
								<form action="#" method="post">
									...
									<p>Tipo de vulneración:<select class="month">
														<option value="">Selecciona</option>
														<option value="01">Violencia</option>
														<option value="02">Discriminación</option>
														<option value="03">Trabajo infantil</option>
														<option value="04">Mendicidad</option>
														
													</select>
													
														</p>

														<p>Cantón:<select class="month">
														<option value="">Rumiñahui</option>
														...
														<p>Parroquia:<select class="month">
														<option value="">Selecciona</option>
														<option value="01">Parroquia 1</option>
														<option value="02">Parroquia 2</option>
														<option value="03">Parroquia 3</option>
														<option value="04">Parroquia 4</option>
														
													</select>
													
														</p>
									<p>Describe la denuncia</p>
									<textarea placeholder="" required=""></textarea>
								   
							</div> 
							<div class="map">
							<div class="form-group-1">
					@include('reusable.maps', ['longitud_servicio' =>-78.499345,'latitud_servicio'=>-0.163702])  
