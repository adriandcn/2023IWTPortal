    ...
    <body class="full-padding" style="margin: 0;padding: 0;min-width: 100%;background-color: #1e1e1e;">
        ...
        <center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #1e1e1e;">
            <table class="preheader" style="border-collapse: collapse;border-spacing: 0;width: 100%;background-color: #161616;">
                <tbody><tr>
                        <td class="title" style="padding: 9px;vertical-align: top;font-family: Cabin,Avenir,sans-serif;color: #e6e6e6;font-size: 11px;line-height: 16px;text-align: left;">Invitaci&#243;n registro de operadores</td>
                                ...
                                <tbody><tr>
                                        <td class="column" style="padding: 0;vertical-align: top;text-align: left;">
                                            ...
                                            <div class="image" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: Cabin,Avenir,sans-serif;color: #fff;" align="center">
                                                <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 900px;" src="{!! url(env('AWS_PUBLIC_URL').'images/img/cotopaxi.jpg')!!}" alt="iwanatrip.com" width="600" height="293" />
                                            </div>
                                                ...
                                                <tbody><tr>
                                                        <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word;text-align: left;">
                                                            ...
                                                            <h3 style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 32px;font-size: 16px;line-height: 24px;font-family: Cabin,Avenir,sans-serif;color: #707f8f;text-align: center;">
                                                                Bienvenido, te han invitado a ser parte de la red de viajeros
                                                            </h3>
                                                            ...
                                                            <ul style="font-style: normal;font-weight: 400;padding-left: 0;Margin-bottom: 32px;Margin-top: 32px;font-size: 14px;line-height: 22px;font-family: Cabin,Avenir,sans-serif;color: #fff;Margin-left: 48px;">
                                                                ...
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 0;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    Formar parte de la red tur&#237;stica m&#225;s grande del Ecuador.</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    Tus servicios ser&#225;n conocidos a nivel nacional e internacional</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    Retroalimentaci&#243;n continua.</li>
                                                                <li style="padding-left: 13px;list-style-type: disc;list-style-position: outside;Margin-bottom: 0;Margin-top: 10px;list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);text-align: left;">
                                                                    Recomendaciones, mejoras, y mucho m&#225;s</li>
                                                            </ul>
