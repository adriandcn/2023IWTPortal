	...
	<body class="landing">
		...
		<!-- Page Wrapper -->
            ...
            <div id="logo-imagen">
                ...
                <a href="#" onclick="window.location.href = '{!!asset('/')!!}'"><img src="{{ url(env('AWS_PUBLIC_URL').'images/img/index-logo.png')}}" width="100" height="88" alt="IguanaTrip" /></a>
            </div>
				...
				<!-- Two -->
					<section id="two" class="wrapper alt style2">
						...
						<section class="spotlight">
							<div class="image"><img data-u="image" src="{{ url(env('AWS_PUBLIC_URL').'images/img/cotopaxi.jpg')}}" /></div><div class="content">
								<h2>{{ trans('welcome/index.labelAbout')}}</h2>
								<p>{{ trans('welcome/index.descrip2')}}</p>
							</div>
						</section>
						<section class="spotlight">
							<div class="image"><img src="{!! url(env('AWS_PUBLIC_URL').'images/img/extra-pag-1b.png')!!}" alt="" /></div><div class="content">
				...
				<!-- Footer -->
					<footer id="footer">
						...
						<ul class="copyright">
							<li>&copy; iWaNaTrip.com</li><li>2016</li>
						</ul>
					</footer>
