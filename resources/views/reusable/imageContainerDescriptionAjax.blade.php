    ...
    <div class="row">
        <div class="span12">
            ...
            <div id="owl-demo" class="owl-carousel">
                ...
                <?php
                $url = env('AWS_PUBLIC_URL')."images/icon/" . $imagen->filename
                ?>

                <div class="item">
                    <img src="{!! url(env('AWS_PUBLIC_URL').'images/img/x.png')!!}" onclick='alertaConfirm({!!$imagen->id!!})' style=" width:25px; height:29px; position:absolute; top:2px; right:0px; cursor:pointer;" alt='' />
