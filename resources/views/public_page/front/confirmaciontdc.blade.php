...
<body class="woocommerce">
        ...
        <div class="container">
            <div class="row" id="print">
                <div id="main" class="col-sm-12 col-md-12">
                    <h1 class="entry-title" style="text-align:center;padding:4%;">{{ trans('booking/labels.tdclabel4')}}
                    </h1>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="woocommerce-billing-fields box">
                                        ...
                                        <div class="form-group column-2 no-column-bottom-margin">
                                            <label
                                                style="padding-bottom:1%;">{{ trans('booking/labels.label1-1')}}</label>
                                            <input class="input-text full-width" placeholder="First name" type="text"
                                                value="{!!$infoAgrupamiento[0]->nombre!!}" readonly="">
                                        </div>
                                        <div class="form-group column-2 no-column-bottom-margin">
                                            <label
                                                style="padding-bottom:1%;">{{ trans('booking/labels.label1-2')}}</label>
                                            <textarea class="input-text full-width" id="infoTour" rows="4" cols="50"
                                                readonly=""
                                                style="resize: none !important;">{!!$infoAgrupamiento[0]->descripcion!!}</textarea>
                                        </div>
                                        <div class="form-group column-2 no-column-bottom-margin">
                                            <label
                                                style="padding-bottom:1%;">{{ trans('booking/labels.label1')}}</label>
                                            <input class="input-text full-width" placeholder="First name" type="text"
                                                value="{!!$infoReserva2[0]->nombre_contacto_operador_1!!}" readonly="">
                                        </div>
                                        <div class="form-group">
                                            <label
                                                style="padding-bottom:1%;">{{ trans('booking/labels.label2')}}</label>
                                        ...
                                        <table class="shop_table box" id="basic-table">
                                            ...
                                            <tbody>
                                                <tr class="cart_item">
                                                    ...
                                                    <td class="product-total">
                                                        <span
                                                            class="amount">{!!$infoPago[0]->nombre_calendario!!}</span>
                                                    </td>
                                                </tr>
                                                <tr class="cart_item">
                                                    <td class="product-name">
                                            ...
                                            <tfoot>
                                                <tr class="product-name">
                                                    ...
                                                    <td><span class="amount"> <strong>{!!$infoReservas[0]->amount!!}
                                                                $</strong></span></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                    ...
                    <div class="text-center">
                        ...
                        <button class="btn btn-default"
                            onclick="window.location.href ='{{ asset('/tour/'.$infoAgrupamiento[0]->nombre.'/'.$idUsuarioServicio.'/'.$infoAgrupamiento[0]->id)}}'">{{ trans('booking/labels.label23')}}</button>
                        <!-- <button class="btn btn-default" onclick="window.location.href ='https://iwannatrip.com/'">{{ trans('booking/labels.label23')}}</button>-->
                    </div>
                </div>
            </div>
        </div>
    ...
    <a href="{{ asset('/pdf/Reservacion-'.$infoReservas[0]->c_name.'-'.$infoPago[0]->id.'.pdf')}}" download
        id="download" hidden></a>
    {{-- <a href="{{ $pdfReserva }}" download id="download" hidden></a> --}}
    ...
    <!--
        <script>
            ...
            var header = function(data) {
                ...
                doc.text(20, 65, 'Nombre Tour: {!!$infoAgrupamiento[0]->nombre!!}');
                doc.text(20, 70, 'Detalle del Tour:');
                var splitTitle = doc.splitTextToSize(res1, 180);
                doc.text(20, 75, splitTitle);
                //doc.text(80, 77, 'Informacion de la Reservacion');
                doc.text(80, 160, 'Informacion de la Reservacion');
                //imagen del codigo QR de la reserva
                doc.addPage();
                doc.text(80, 20, 'Codigo de la Reservacion');
                doc.addImage(imgData, 'JPEG', 80, 30, 50, 50);
    ...
    <script>
        (function () {
            sjq('#create_pdf').on('click', function () {
                var base_url = '{!! url() !!}';
                // document.getElementById('download').click();
                let urlDownload = base_url + '/downloadpdfbucket/{!!$fileName!!}';
