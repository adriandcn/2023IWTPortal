                        ...
                        <div class="product-images col-sm-6 box-lg">
                                    ...
                                    <div id="sync1" class="owl-carousel images">
                                        <div class="post-slider style3 owl-carousel box">
                                            ...
                                            <a href="{{ url(env('AWS_PUBLIC_URL').'images/fullsize/'.$imagen->filename)}}" class="soap-mfp-popup">
                                                <img src="{{ url(env('AWS_PUBLIC_URL').'images/icon/'.$imagen->filename)}}" alt="{!!$evento[0]->nombre_evento!!}">
                                            ...
                                            <?php $header= url(env('AWS_PUBLIC_URL').'images/fullsize/'.$imagenes[0]->filename)?>
                                             <a href="{{ url(env('AWS_PUBLIC_URL').'images/fullsize/'.$imagenes[0]->filename)}}" class="soap-mfp-popup">
                                                <img src="{{ url(env('AWS_PUBLIC_URL').'images/icon/'.$imagenes[0]->filename)}}" alt="{!!$evento[0]->nombre_evento!!}">
                                    ...
                                    <div id="sync2" class="owl-carousel post-slider style3 thumbnails" data-items="4">
                                         @foreach ($imagenes as $imagen)
                                          ...
                                          <div class="item">
                                            <a href="{{ url(env('AWS_PUBLIC_URL').'images/fullsize/'.$imagen->filename)}}" class="soap-mfp-popup"><img src="{{ url(env('AWS_PUBLIC_URL').'images/icon/'.$imagen->filename)}}" alt="{!!$evento[0]->nombre_evento!!}"></a>
                                        </div>
                                            @endforeach
                                    </div>
                        </div>
