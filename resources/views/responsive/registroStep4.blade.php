                                ...
                                <div class="tab-container full-width style2">
                                    ...
                                    <div id="tab2-12" class="tab-content in active" style="border: 1px solid #edf6ff">
                                        <div class="tab-pane" style="margin:2%;">
                                            ...
                                            <div class="form-group">
                                                {!!Form::label('fuente_1', 'Fuente', array('class'=>'control-label-2'))!!}
                                                <input type="text" name="fuente" value="{!!$usuarioServicio->fuente!!}" class="input-text chng" style="width: 100%;"
                                                       placeholder="Fuente" title="Fuente">
                                            </div>
                                        </div>
                                    </div>
                                </div>
