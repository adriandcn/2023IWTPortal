                                    ...
                                    <div id="sync1" class="owl-carousel images">
                                        <div class="post-slider style3 owl-carousel box">
                                           <?php //print_r($imagenes);echo count($imagenes);die();?>
                                            ...
                                            <?php $header= url(env('AWS_PUBLIC_URL').'images/fullsize/'.$imagen->filename)?>
                                    ...
                                    <div id="sync2" class="owl-carousel post-slider style3 thumbnails" data-items="4">
                                        @if(isset($imagenes) && count($imagenes)>0)
                                         ...
                                         @foreach ($imagenes as $imagen)
                                          ...
                                          <div class="item">
                                            <a href="#"><img src="{{ url(env('AWS_PUBLIC_URL').'images/icon/'.$imagen->filename)}}" alt="{!!$atraccion->nombre_servicio!!}"></a>
                                            ...
                                            <ol class="commentlist">
                                                ...
                                                <li class="comment">
                                                    ...
                                                    <div class="author-img">
                                                        ...
                                                        <span><img src="{{ url(env('AWS_PUBLIC_URL').'images/icon/'.$img->filename)}}" alt=""></span>
                                                        @endif
                                                        @endforeach
                                                        @else
