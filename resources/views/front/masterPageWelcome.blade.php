        ...
        <div id="target">
            ...
            <div id="logo_">
                    <div id="logo-imagen">
                        ...
                        <a href="#" onclick="window.location.href = '{!!asset('/')!!}'"><img src="{{ url(env('AWS_PUBLIC_URL').'images/img/index-logo.png')}}" width="230" height="218" alt="iWaNaTrip" /></a>
                    </div>
            ...
            <div id="lang">
                ...
                <a href="{!! url('language') !!}"><img width="32" height="32" alt="en" src="{!! url(env('AWS_PUBLIC_URL').'images/img/' . (session('locale') == 'es' ? 'english' : 'espanol') . '-flag.png') !!}"></a>
            </div>
