    ...
    <body class="full-padding" style="margin: 0;padding: 0;min-width: 100%;background-color: #1e1e1e;">
        ...
        <center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #1e1e1e;">
            <table class="preheader" style="border-collapse: collapse;border-spacing: 0;width: 100%;background-color: #161616;">
                <tbody><tr>
                        <td class="title" style="padding: 9px;vertical-align: top;font-family: Cabin,Avenir,sans-serif;color: #e6e6e6;font-size: 11px;line-height: 16px;text-align: left;">iWaNaTrip Email Confirmation</td>
                                                ...
                                                <tbody><tr>
                                                        <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word;text-align: left;">
                                                            ...
                                                            <h3 style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 32px;font-size: 16px;line-height: 24px;font-family: Cabin,Avenir,sans-serif;color: #707f8f;text-align: center;">
                                                                Hello {!!$nombrepara!!}, thanks for your reservation.
                                                            </h3>
                                                            ...
                                                            <h1 style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 12px;font-size: 30px;line-height: 40px;font-family: Cabin,Avenir,sans-serif;color: #d49344;text-align: center;">
                                                                Email confirmation iWaNaTrip.com</h1>
                                                             ...
                                                             <p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 16px;font-size: 14px;line-height: 22px;font-family: Cabin,Avenir,sans-serif;color: #fff;">
                                                                Check your reservation:</p>
                                                            <div style="text-align:center;">
                                                                <a href="{!!$url!!}" target="_blank" style="font-family: Cabin,Avenir,sans-serif;color: #d49344;font-weight: bold;text-align: center">View reservation</a>
                                                            </div>
                                ...
                                <tbody><tr>
                                        <td style="padding: 0;vertical-align: top;color: #e6e6e6;font-size: 12px;line-height: 22px;text-align: left;width: 400px;">
                                            ...
                                            <div class="permission" style="font-family: Cabin,Avenir,sans-serif;">
                                                <div>You have recived an email confirmation</div>
                                            </div>
