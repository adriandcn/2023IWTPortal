...
<html lang="en">
<head>
<title>Jupiter App A Mobile App Flat Bootstrap Responsive Website | Single ::</title>
...
<meta charset utf="8">
<!--font-awsome-css-->
     <link rel="stylesheet" href="{{asset('/Jupiter/css/font-awesome.min.css')}}"> 
<!--bootstrap-->
	<link href="{{asset('/Jupiter/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css">
<!--custom css-->
	<link href="{{asset('/Jupiter/css/style.css')}}" rel="stylesheet" type="text/css"/>
<!--component-css-->
	<script src="{{asset('/Jupiter/js/jquery-2.1.4.min.js')}}"></script>
    <script src="{{asset('/Jupiter/js/bootstrap.min.js')}}"></script>
<!--script-->
	<script src="{{asset('/Jupiter/js/modernizr.custom.js')}}"></script>
    <script src="{{asset('/Jupiter/js/bigSlide.js')}}"></script>
           <script>
...
<!-- //web-fonts -->
<!-- pop-up-box -->
<script src="{{asset('/Jupiter/js/jquery.magnific-popup.js')}}" type="text/javascript"></script>
	    <script>
			$(document).ready(function() {
		...
		<div class="phone-box wrap push" id="home">
			<div class="menu-notify">
				...
				<div class="Profile-mid">
					<h5 class="pro-link"><a href="main.html">Jupiter</a></h5>
				</div>
...
<!-- banner -->
   ...
   <!--/welcome-->
		        <div class="w3agile welcome"> 
					<h3 class="w3ls-title">Consejo Cantonal de protección de derechos</h3> 
					<div class="b-bottom">
			<div class="col-md-6 banner_bottom_left">
				<h3>RUMIÑAHUI</h3>
				<p><i>Quienes somos</i> El COPRODER es el encargado de elaborar y socializar políticas públicas de igualdad y coordinar el Sistema de Proteción Integral de Rumiñahui SIPIDER.</p>
			...
			<div class="col-md-6 banner_bottom_right">
				<div class="wthree_banner_bottom_right_grids">
					<div class="col-md-6 banner_bottom_right_grid">
						...
						<img src="https://pbs.twimg.com/media/D8JjcW4W4AMUu7W.jpg" class="img-responsive" alt="">
							
							<div class="mask">
							    <a href="/form">
									  <div class="agile_text_box">
											
											<h3>Vulneración Niñez y adolecencia</h3>
											<p>Denuncia aquí.</p>
									  </div>
								 </a>
							</div>
					...
					<div class="col-md-6 banner_bottom_right_grid">
						<div class="view view-tenth">
						<img src="https://image.freepik.com/foto-gratis/foto-blanco-negro-primer-plano-manos-personas-mayores_53876-47439.jpg" class="img-responsive" alt="">
							
							<div class="mask">
							   <a href="train.html">
									<div class="agile_text_box">
									
										<h3>Vulneración Adultos mayores</h3>
										<p>Denuncia aquí.</p>
									</div>
								</a>
							</div>
				...
				<div class="wthree_banner_bottom_right_grids">
					<div class="col-md-6 banner_bottom_right_grid">
						<div class="view view-tenth">
						<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSu0IZpN3VYXL_JiaVVGQr12mUqtILm7YxHGw&usqp=CAU" class="img-responsive" alt="">
							
							<div class="mask">
							  <a href="bus.html">
								<div class="agile_text_box">
									
									<h3>Vulneración Intrafamiliar</h3>
									<p>Denuncia aquí.</p>
								</div>
							   </a>
							</div>
    ...
    <div class="w3agile footer">
			<div class="col-md-3 w3agile_footer_grid">
				...
				<p>Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis 
					voluptatibus.</p>
				<h3 class="logo"><a href="main.html">J<span>u</span>p<span>i</span>e<span>r</span></a></h3>
			</div>
		...
		<div class="w3agile agileinfo_copy_right">
			<div class="agileinfo_copy_right_left">
				<p>© 2020 Jupiter. All rights reserved | Design by </p>
			</div>
...
<script src="{{asset('/Jupiter/js/jquery.nicescroll.js')}}"></script>
<script src="{{asset('/Jupiter/js/scripts.js')}}"></script>
</body>
</html>