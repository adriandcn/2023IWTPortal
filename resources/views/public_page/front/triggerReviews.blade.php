...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        <!-- Page Title -->
        <title> Cron Reviews | iWaNaTrip</title>
        <!-- Page Title -->
        <title> Cron Reviews | iWaNaTrip</title>
        <!-- Meta Tags -->
        <meta charset="utf-8">
  ...
  ga('send', 'pageview');
    ...
    <body class="woocommerce">
        <div id="page-wrapper">
            ...
            @include('public_page.reusable.banner', ['titulo' =>'Cron Reviews Tours'])
            <ul class="breadcrumbs">
                <li><a href="{!!asset('/')!!}"  onclick="$('.woocommerce').LoadingOverlay('show')">{{ trans('publico/labels.label1')}}</a></li>
                <li class="active">Cron Reviews</li>
            </ul>
        </div>
                        ...
                        <div class="product type-product">
                            <center>
                                <div class="form-group">
                                    <a onclick="ejecutarCron()" class="btn style1">Ejecutar Cron</a>
                                </div>
                            </center>
                        </div>
                    </div>
    ...
    function ejecutarCron(){
        AjaxCronReviewsTours("{!!asset('/cronReviewsTours')!!}");
    }
